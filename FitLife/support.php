      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Contact</h1>
              <p class="mb-0">Have any questions or need support? Fill out the form below, and our team will get back to you shortly.<br> We're here to help you on your Fitness journey!</p>
            </div>
          </div>
        </div>
      </div>
